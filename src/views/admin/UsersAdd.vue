                ...
                <b-col md="2">
                  <b-form-group>
                    <b-input-group>
                      ...
                      <b-form-input v-model="user.NationalId" type="number" placeholder="کد ملی"></b-form-input>
                    </b-input-group>
                  </b-form-group>
                ...
                <b-col md="2">
                  <b-form-group>
                    <b-input-group>
                      ...
                      <b-form-input v-model="user.Passcode" type="password" placeholder="رمز عبور"></b-form-input>
                    </b-input-group>
                  </b-form-group>
                ...
                <b-col md="2">
                  <b-form-group>
                    <b-input-group>
                      ...
                      <b-form-input :state="user.Passcode==user.PasscodeVerify ? true : false" v-model="user.PasscodeVerify" type="password" placeholder="تکرار رمز عبور"></b-form-input>
                    </b-input-group>
                  </b-form-group>
                  <div v-if="$v.user.Passcode.$error">
                    <div class="text-danger" v-if="!$v.user.Passcode.required">تکمیل این فیلد الزامی است.</div>
